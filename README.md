...
### 6.1.Товары
Наибольшую выручку приносят товары с большой ценой (кроме LG Dryer и LG Washing machine, т.е. бытовая техника). 
...
На графике видно, как сильно число заказов и выручка коррелируют между собой. Это можно назвать недостатком генерации данного датасета, на реальных данных мы бы не увидели подобной картины.
